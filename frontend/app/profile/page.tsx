		...
		<div className="lj-profile-info">
			<div className="lj-profile-header">
				...
				<div className="lj-profile-details">
					...
					<div className="lj-profile-motto">
						you speak only in riddles and loss
					</div>{" "}
					<div className="lj-profile-actions">
						<span className="lj-pro-badge">PRO</span>
						<a href="/pro" className="lj-profile-link">
							Enable a Professional package
						</a>
					</div>
				</div>
				<div className="lj-profile-settings">
					<button type="button" className="lj-settings-icon">
						⚙️
					</button>
				</div>
			</div>{" "}
			<div className="lj-profile-tabs">
				<a href="/" className="lj-tab">
					RECENT ENTRIES
				</a>
				<a href="/friends" className="lj-tab">
					FRIENDS
				</a>
				<a href="/profile" className="lj-tab active">
					PROFILE
				</a>
				<a href="/archive" className="lj-tab">
					ARCHIVE
				</a>
				<a href="/tags" className="lj-tab">
					TAGS
				</a>
				<a href="/categories" className="lj-tab">
					CATEGORIES
				</a>
				<a href="/memories" className="lj-tab">
					MEMORIES
				</a>
				<a href="/photos" className="lj-tab">
					MY PHOTO
				</a>
				<a href="/videos" className="lj-tab">
					MY VIDEO
				</a>
			</div>
	...
	return (
		<div className="lj-profile-stats">
			<div className="lj-widget">
				<div className="lj-widget-header">STATISTICS</div>
