    ...
    <div className="lj-top-header">
      <div className="lj-header-content">
        ...
        <div className="lj-user-section">
          <a href="/" className="lj-post-button" style={{ textDecoration: 'none', color: 'white' }}>POST NEW ENTRY</a>
...
interface NavigationProps {
  activePage?: "recent" | "friends" | "archive" | "profile" | "memories" | "rss";
}
  ...
  return (
    <div className="lj-nav">
      <div className="lj-nav-tabs">
        <a href="/" className={activePage === "recent" ? "active" : ""}>RECENT ENTRIES</a>
        <a href="/friends" className={activePage === "friends" ? "active" : ""}>FRIENDS</a>
        <a href="/archive" className={activePage === "archive" ? "active" : ""}>ARCHIVE</a>
        <a href="/profile" className={activePage === "profile" ? "active" : ""}>PROFILE</a>
        <a href="/add" className={activePage === "memories" ? "active" : ""}>ADD TO MEMORIES</a>
        <a href="/rss" className={activePage === "rss" ? "active" : ""}>RSS</a>
      </div>
    </div>
  );
};
